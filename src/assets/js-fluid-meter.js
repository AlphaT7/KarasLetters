...
function FluidMeter() {
  ...
  function drawBubblesLayer(dt) {
    ...
    for (let i = 0; i < bubblesLayer.bubbles.length; i++) {
      let bubble = bubblesLayer.bubbles[i];
      ...
      let currentSpeed = bubblesLayer.current * dt;
  ...
  function drawText() {
    let text = options.drawPercentageSign
